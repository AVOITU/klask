 ...
 */
final class Version20260408134646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE profession (id INT AUTO_INCREMENT NOT NULL, description_profession VARCHAR(500) DEFAULT NULL, code_rom VARCHAR(5) NOT NULL, narrator_profession VARCHAR(50) DEFAULT NULL, UNIQUE INDEX UNIQ_BA930D699172380B (code_rom), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
