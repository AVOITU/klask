 ...
 */
final class Version20260415133959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activity_category (id INT AUTO_INCREMENT NOT NULL, type_category VARCHAR(255) NOT NULL, nbr_points INT NOT NULL, nbr_max_activity INT NOT NULL, beginning_hour_category DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profession (id INT AUTO_INCREMENT NOT NULL, description_profession VARCHAR(500) DEFAULT NULL, code_rom VARCHAR(5) NOT NULL, narrator_profession VARCHAR(50) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sphere (id INT AUTO_INCREMENT NOT NULL, name_sphere VARCHAR(100) NOT NULL, color_sphere VARCHAR(50) NOT NULL, description_sphere LONGTEXT DEFAULT NULL, category_id INT DEFAULT NULL, INDEX IDX_55F9668712469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo_user VARCHAR(180) NOT NULL, password VARCHAR(40) DEFAULT NULL, authority_id INT NOT NULL, group_id INT NOT NULL, UNIQUE INDEX UNIQ_8D93D649EA5002AD (pseudo_user), INDEX IDX_8D93D64981EC865B (authority_id), INDEX IDX_8D93D649FE54D947 (group_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 ENGINE = InnoDB');
