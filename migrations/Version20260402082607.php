 ...
 */
final class Version20260402082607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo_user VARCHAR(255) NOT NULL, password VARCHAR(40) DEFAULT NULL, authority_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_8D93D64981EC865B (authority_id), INDEX IDX_8D93D649FE54D947 (group_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
